    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BrowsingHistroyID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ApplicationUserId = table.Column<string>(nullable: true),
                    ProductID = table.Column<int>(nullable: false),
                    UserName = table.Column<string>(nullable: true),
                    Viewed = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BrowsingHistory", x => x.BrowsingHistroyID);
                    table.ForeignKey(
                        name: "FK_BrowsingHistory_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BrowsingHistory_Product_ProductID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BrowsingHistory_ApplicationUserId",
                table: "BrowsingHistory",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_BrowsingHistory_ProductID",
                table: "BrowsingHistory",
                column: "ProductID");
